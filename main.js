...
var running;
var model;
//var gamepad = new GamePad(); // moved for Acorn Atom
var availableImages;
var discImage;
var extraRoms = [];
...
var $screen = $("#screen");
if (model.isAtom) $screen = $("#nec-tv-screen");

var canvas = tryGl ? canvasLib.bestCanvas($screen[0]) : new canvasLib.Canvas($screen[0]);
video = new Video(model.isMaster, model.isAtom, canvas.fb32, function paint(minx, miny, maxx, maxy) {
    frames++;
...
(function () {
    ...
    var monitorpic = "#cub-monitor-pic";
    if (processor.model.isAtom) {
        monitortype = "#nec-tv";
        monitorpic = "#nec-tv-pic";
    }
    const $cubMonitor = $(monitortype);
    const $cubMonitorPic = $(monitorpic);
